...
def init_database():
    ...
    try:
        ...
        # 插入卡牌数据 - 铁甲战士
        con.execute("""
        INSERT INTO cards (id, name, card_type, rarity, energy_cost, description, character_id) VALUES
        (1, '打击', '攻击', '基础', 1, '造成6点伤害', 1),
        (2, '防御', '技能', '基础', 1, '获得5点格挡', 1),
        (3, '愤怒', '技能', '普通', 0, '获得3点临时力量', 1),
        (4, '重击', '攻击', '普通', 2, '造成14点伤害', 1),
        (5, '铁斩波', '攻击', '普通', 1, '造成8点伤害', 1),
        (6, '顺势斩', '攻击', '普通', 1, '造成12点伤害，如果你有格挡，则造成16点伤害', 1),
        (7, '战斗呐喊', '技能', '稀有', 0, '获得1点力量', 1),
        (8, '血肉奉献', '技能', '稀有', 2, '获得8点力量，失去6点生命', 1),
        (9, '狂暴打击', '攻击', '稀有', 3, '对所有敌人造成8点伤害3次', 1)
        """)
        
        # 插入卡牌数据 - 静默猎手
        con.execute("""
        INSERT INTO cards (id, name, card_type, rarity, energy_cost, description, character_id) VALUES
        (10, '打击', '攻击', '基础', 1, '造成6点伤害', 2),
        (11, '防御', '技能', '基础', 1, '获得5点格挡', 2),
        (12, '毒刃', '攻击', '普通', 1, '造成5点伤害，给予2层中毒', 2),
        (13, '闪避', '技能', '普通', 1, '获得8点格挡，抽1张牌', 2),
        (14, '致命毒素', '技能', '普通', 1, '给予5层中毒', 2),
        (15, '刀刃之舞', '攻击', '普通', 1, '造成4点伤害2次', 2),
        (16, '暗影步伐', '技能', '稀有', 1, '获得6点格挡，抽2张牌', 2),
        (17, '毒雾弹', '技能', '稀有', 2, '给予所有敌人4层中毒，抽3张牌', 2),
        (18, '伏击', '攻击', '稀有', 0, '造成4点伤害，抽1张牌', 2)
        """)
        
        # 插入卡牌数据 - 缺陷机器人
        con.execute("""
        INSERT INTO cards (id, name, card_type, rarity, energy_cost, description, character_id) VALUES
        (19, '打击', '攻击', '基础', 1, '造成6点伤害', 3),
        (20, '防御', '技能', '基础', 1, '获得5点格挡', 3),
        (21, '闪电球', '技能', '普通', 1, '生成1个闪电球', 3),
        (22, '冰霜球', '技能', '普通', 1, '生成1个冰霜球', 3),
        (23, '双重施法', '技能', '普通', 1, '下一张技能牌打出两次', 3),
        (24, '自我修复', '技能', '普通', 1, '回复3点生命，抽1张牌', 3),
        (25, '火球术', '攻击', '普通', 1, '造成10点伤害', 3),
        (26, '能量涌动', '技能', '稀有', 2, '获得2点能量，抽2张牌', 3),
        (27, '核心过载', '能力', '稀有', 3, '每回合开始时生成1个闪电球和1个冰霜球', 3),
        (28, '数据分析', '技能', '稀有', 1, '抽3张牌，丢弃1张牌', 3)
        """)
